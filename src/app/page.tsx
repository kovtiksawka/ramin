...
export default function Home() {
  const awardsData = [
    ...
    items: [
       "Двукратный серебряный призер международного турнира 'Восток-Запад' по профессиональному боевому самбо",
      "Двукратный серебряный призер международного турнира на призы ОДКБ"
    ]
  },
  {
    category: "Чемпионаты России",
    items: [
      "Чемпион Кубка России по КЕ",
      "Двукратный серебряный призер Кубка России по КЕ",
      "Чемпион Всероссийского турнира памяти Васильева по боевому самбо",
      "Чемпион Всероссийского турнира памяти Рябухина по рукопашному бою",
      "Чемпион Кубка Балтики по боевому самбо"
    ]
  },
  {
    ...
    items: [
      ...
      "Серебряный призер Приволжского округа по рукопашному бою"
    ]
  },
];
